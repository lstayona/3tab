...
abstract class BaseAdjudicatorFeedbackSheet extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::ID;
		}
	...
	public function setAdjudicatorId($v)
	{
		...
		if ($this->adjudicator_id !== $v) {
			...
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ID;
		}
	...
	public function setAdjudicatorAllocationId($v)
	{
		...
		if ($this->adjudicator_allocation_id !== $v) {
			...
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ALLOCATION_ID;
		}
	...
	public function setDebateTeamXrefId($v)
	{
		...
		if ($this->debate_team_xref_id !== $v) {
			...
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::DEBATE_TEAM_XREF_ID;
		}
	...
	public function setComments($v)
	{
		...
		if ($this->comments !== $v) {
			$this->comments = $v;
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::COMMENTS;
		}
	...
	public function setScore($v)
	{
		...
		if ($this->score !== $v) {
			$this->score = $v;
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::SCORE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = AdjudicatorFeedbackSheetPeer::UPDATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->adjudicator_allocation_id = $rs->getInt($startcol + 2);

			$this->debate_team_xref_id = $rs->getInt($startcol + 3);
			...
			throw new PropelException("Error populating AdjudicatorFeedbackSheet object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			AdjudicatorFeedbackSheetPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(AdjudicatorFeedbackSheetPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(AdjudicatorFeedbackSheetPeer::UPDATED_AT))
    {
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aDebateTeamXref !== null) {
				...
				$this->setDebateTeamXref($this->aDebateTeamXref);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AdjudicatorFeedbackSheetPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += AdjudicatorFeedbackSheetPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AdjudicatorFeedbackSheetPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AdjudicatorFeedbackSheetPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AdjudicatorFeedbackSheetPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getAdjudicatorId(),
			$keys[2] => $this->getAdjudicatorAllocationId(),
			$keys[3] => $this->getDebateTeamXrefId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAdjudicatorAllocationId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setDebateTeamXrefId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::ID)) $criteria->add(AdjudicatorFeedbackSheetPeer::ID, $this->id);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ID)) $criteria->add(AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ID, $this->adjudicator_id);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ALLOCATION_ID)) $criteria->add(AdjudicatorFeedbackSheetPeer::ADJUDICATOR_ALLOCATION_ID, $this->adjudicator_allocation_id);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::DEBATE_TEAM_XREF_ID)) $criteria->add(AdjudicatorFeedbackSheetPeer::DEBATE_TEAM_XREF_ID, $this->debate_team_xref_id);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::COMMENTS)) $criteria->add(AdjudicatorFeedbackSheetPeer::COMMENTS, $this->comments);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::SCORE)) $criteria->add(AdjudicatorFeedbackSheetPeer::SCORE, $this->score);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::CREATED_AT)) $criteria->add(AdjudicatorFeedbackSheetPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(AdjudicatorFeedbackSheetPeer::UPDATED_AT)) $criteria->add(AdjudicatorFeedbackSheetPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AdjudicatorFeedbackSheetPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new AdjudicatorFeedbackSheetPeer();
		}
		return self::$peer;
	}
