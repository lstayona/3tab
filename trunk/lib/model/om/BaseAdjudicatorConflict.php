...
abstract class BaseAdjudicatorConflict extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AdjudicatorConflictPeer::ID;
		}
	...
	public function setTeamId($v)
	{
		...
		if ($this->team_id !== $v) {
			$this->team_id = $v;
			$this->modifiedColumns[] = AdjudicatorConflictPeer::TEAM_ID;
		}
	...
	public function setAdjudicatorId($v)
	{
		...
		if ($this->adjudicator_id !== $v) {
			...
			$this->modifiedColumns[] = AdjudicatorConflictPeer::ADJUDICATOR_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = AdjudicatorConflictPeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = AdjudicatorConflictPeer::UPDATED_AT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating AdjudicatorConflict object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			AdjudicatorConflictPeer::doDelete($this, $con);
	...
	{
    if ($this->isNew() && !$this->isColumnModified(AdjudicatorConflictPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(AdjudicatorConflictPeer::UPDATED_AT))
    {
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aAdjudicator !== null) {
				...
				$this->setAdjudicator($this->aAdjudicator);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AdjudicatorConflictPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += AdjudicatorConflictPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AdjudicatorConflictPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AdjudicatorConflictPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AdjudicatorConflictPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdjudicatorConflictPeer::ID)) $criteria->add(AdjudicatorConflictPeer::ID, $this->id);
		if ($this->isColumnModified(AdjudicatorConflictPeer::TEAM_ID)) $criteria->add(AdjudicatorConflictPeer::TEAM_ID, $this->team_id);
		if ($this->isColumnModified(AdjudicatorConflictPeer::ADJUDICATOR_ID)) $criteria->add(AdjudicatorConflictPeer::ADJUDICATOR_ID, $this->adjudicator_id);
		if ($this->isColumnModified(AdjudicatorConflictPeer::CREATED_AT)) $criteria->add(AdjudicatorConflictPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(AdjudicatorConflictPeer::UPDATED_AT)) $criteria->add(AdjudicatorConflictPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AdjudicatorConflictPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new AdjudicatorConflictPeer();
		}
		return self::$peer;
	}
