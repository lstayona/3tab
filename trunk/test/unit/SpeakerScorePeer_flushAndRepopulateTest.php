...
SpeakerScorePeer::flushAndRepopulate($con);

$c = new Criteria();
$t->is(SpeakerScorePeer::doCount($c, true, $con), 102, '-> correct number of speaker_scores entries.');
$c->add(SpeakerScorePeer::TOTAL_SPEAKER_SCORE, 0, Criteria::GREATER_THAN);
$t->is(SpeakerScorePeer::doCount($c, true, $con), 6, '-> correct number of entries returned for active speakers.');

$t->is(DebaterPeer::retrieveByName('swing_a_speaker1', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76.5, '-> correct total speaker score returned for swing_a_speaker1');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker3', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75.5, '-> correct total speaker score returned for swing_a_speaker3');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker2', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76, '-> correct total speaker score returned for swing_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker2', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75, '-> correct total speaker score returned for iiu_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker1', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75, '-> correct total speaker score returned for iiu_a_speaker1');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker3', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76, '-> correct total speaker score returned for iiu_a_speaker3');
...
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker1', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75 + 77, '-> correct total speaker score returned for iiu_a_speaker1');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker2', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75 + 76, '-> correct total speaker score returned for iiu_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker3', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76 + 77, '-> correct total speaker score returned for iiu_a_speaker3');

$t->is(DebaterPeer::retrieveByName('swing_a_speaker2', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76 + 75, '-> correct total speaker score returned for swing_a_speaker2');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker3', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 75.5 + 76, '-> correct total speaker score returned for swing_a_speaker3');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker1', $con)->getSpeakerScore($con)->getTotalSpeakerScore(), 76.5 + 77, '-> correct total speaker score returned for swing_a_speaker1');
