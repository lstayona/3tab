...
$t->is(DebaterPeer::retrieveByName('swing_a_speaker1', $con)->deriveTotalSpeakerScore($con), 76.5, '-> correct total speaker score returned for swing_a_speaker1');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker3', $con)->deriveTotalSpeakerScore($con), 75.5, '-> correct total speaker score returned for swing_a_speaker3');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker2', $con)->deriveTotalSpeakerScore($con), 76, '-> correct total speaker score returned for swing_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker2', $con)->deriveTotalSpeakerScore($con), 75, '-> correct total speaker score returned for iiu_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker1', $con)->deriveTotalSpeakerScore($con), 75, '-> correct total speaker score returned for iiu_a_speaker1');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker3', $con)->deriveTotalSpeakerScore($con), 76, '-> correct total speaker score returned for iiu_a_speaker3');
...
$t->is(DebaterPeer::retrieveByName('swing_a_speaker1', $con)->deriveTotalSpeakerScore($con), 153.5, '-> correct total speaker score returned for swing_a_speaker1');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker3', $con)->deriveTotalSpeakerScore($con), 151.5, '-> correct total speaker score returned for swing_a_speaker3');
$t->is(DebaterPeer::retrieveByName('swing_a_speaker2', $con)->deriveTotalSpeakerScore($con), 151, '-> correct total speaker score returned for swing_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker2', $con)->deriveTotalSpeakerScore($con), 151, '-> correct total speaker score returned for iiu_a_speaker2');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker1', $con)->deriveTotalSpeakerScore($con), 152, '-> correct total speaker score returned for iiu_a_speaker1');
$t->is(DebaterPeer::retrieveByName('iiu_a_speaker3', $con)->deriveTotalSpeakerScore($con), 153, '-> correct total speaker score returned for iiu_a_speaker3');
